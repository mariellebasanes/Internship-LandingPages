...
<section class="bg-light py-20 overflow-hidden position-relative" style="z-index: 0;">
  ...
  <img src="<?php echo htmlspecialchars($assetsBase ?? 'assets'); ?>/img/bg-assets/human-brain.png" class="position-absolute d-none d-lg-block" style="top: 15%; right: 5%; opacity: 0.4; pointer-events: none; width: 260px; transform: rotate(10deg); z-index: 0;" alt="">
  <img src="<?php echo htmlspecialchars($assetsBase ?? 'assets'); ?>/img/bg-assets/brain.png" class="position-absolute d-none d-lg-block" style="bottom: 10%; left: 5%; opacity: 0.4; pointer-events: none; width: 240px; transform: rotate(-15deg); z-index: 0;" alt="">
  <div class="container position-relative" style="z-index: 1;">
        ...
        <div class="swiper-slide h-auto">
          <div class="card card-bordered overflow-hidden h-100 mx-auto" style="max-width: 350px;">
            ...
            <div class="card-body p-6 d-flex flex-column">
              <span class="badge badge-light-primary fs-9 text-uppercase ls-1 mb-3 align-self-start"><?= htmlspecialchars($m['role']) ?></span>
              <h3 class="fw-bold fs-4 mb-1"><?= htmlspecialchars($m['name']) ?></h3>
              <a href="mailto:<?= htmlspecialchars($m['email']) ?>" class="text-gray-600 fs-7 d-block mb-4 text-truncate"><?= htmlspecialchars($m['email']) ?></a>
              ...
              <div class="mt-auto">
                <a href="mailto:<?= htmlspecialchars($m['email']) ?>" class="btn btn-light-primary btn-sm fw-semibold w-100">
    ...
    <style>
      .hover-scale{transition:transform .3s ease;}.card:hover .hover-scale{transform:scale(1.05);}
      #teamSwiper .swiper-pagination-bullet{background-color:var(--bs-primary);opacity:.5;}
      #teamSwiper .swiper-pagination-bullet-active{opacity:1;width:24px;border-radius:8px;}
    </style>

...
<section id="services-v2" class="py-15 py-lg-20 position-relative bg-white">
  ...
  <div class="app-container container-xxl position-relative z-index-1 text-center">
    <!-- Header -->
    <div class="mb-12">
        <span class="badge rounded-pill px-6 py-3 fs-6 fw-bolder text-white tracking-wider shadow-sm mb-6" style="background-color: var(--icare-green);">
            SERVICES
        </span>
    ...
    <div class="row g-12 align-items-center text-start">
        ...
        <div class="col-lg-6">
            <div class="position-relative">
                ...
                <div class="position-absolute top-10 start-10 bg-light-success rounded-4 w-100 h-100" style="z-index: 0; transform: translate(-15px, -15px);"></div>
                <img src="<?php echo htmlspecialchars($BASE); ?>/assets/img/home-education.jfif" class="img-fluid rounded-4 position-relative shadow-sm" style="z-index: 1; object-fit: cover; min-height: 400px; width: 100%;" alt="Study Services">
            </div>
        </div>
        ...
        <div class="col-lg-6 ps-lg-15">
            ...
            <div class="d-flex flex-column gap-8">
                ...
                <div class="d-flex align-items-start gap-5">
                    <div class="symbol symbol-50px symbol-circle bg-light-success d-flex align-items-center justify-content-center flex-shrink-0">
                    ...
                    <div>
                        ...
                        <p class="fs-6 text-muted mb-0 lh-lg">
                            Group study sessions where we break down confusing topics into bite-sized pieces. Bring your questions and snacks!
                        </p>
                    </div>
                </div>
                ...
                <!-- Service Item 2 -->
                <div class="d-flex align-items-start gap-5">
                    <div class="symbol symbol-50px symbol-circle bg-light-warning d-flex align-items-center justify-content-center flex-shrink-0">
                        <i class="ki-outline ki-profile-user fs-2 text-warning"></i>
                    </div>
                    <div>
                        <h4 class="fs-4 fw-bolder text-dark mb-2">One-on-One Help 🎯</h4>
                        <p class="fs-6 text-muted mb-0 lh-lg">
                            Personal tutoring sessions tailored perfectly for you. Whether you're feeling lost or just want to get ahead.
                        </p>
                    </div>
                </div>
                ...
                <!-- Service Item 3 -->
                <div class="d-flex align-items-start gap-5">
                    <div class="symbol symbol-50px symbol-circle bg-light-primary d-flex align-items-center justify-content-center flex-shrink-0">
                        <i class="ki-outline ki-rocket fs-2 text-primary"></i>
                    </div>
                    <div>
                        <h4 class="fs-4 fw-bolder text-dark mb-2">Skill Boosters 💡</h4>
                        <p class="fs-6 text-muted mb-0 lh-lg">
                            Cool workshops and hands-on sessions to teach you pro tips like speed reading and note-taking hacks!
                        </p>
                    </div>
                </div>
            </div>
